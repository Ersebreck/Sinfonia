...
#..... Tracker modules......
import skimage
from yolov7.yolov7_segmentation.segment.sort_count import *
import numpy as np
#...........................
...
from yolov7.yolov7_segmentation.models.common import DetectMultiBackend
from yolov7.yolov7_segmentation.utils.dataloaders import IMG_FORMATS, VID_FORMATS, LoadImages, LoadStreams
from yolov7.yolov7_segmentation.utils.general import (LOGGER, Profile, check_file, check_img_size, check_imshow, check_requirements, colorstr, cv2,
...
from yolov7.yolov7_segmentation.utils.segment.general import process_mask, scale_masks, masks2segments
from yolov7.yolov7_segmentation.utils.segment.plots import plot_masks
from yolov7.yolov7_segmentation.utils.torch_utils import select_device, smart_inference_mode
...
def run(
    ...
    print(f'{s}Done. (Inference:{round(tf-t0,3)})')
    return im0, det[:,[0,1,2,3,5]],tf-t0 
